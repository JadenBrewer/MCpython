...
def field(mc,x,y,z):
	xs = 0;ys = 0;zs = 0
	mc.setBlocks(xs+60,ys,zs+25,xs-60,ys,zs-25,2)
	mc.setBlocks(xs+60,ys,zs+25,xs-60,ys,zs+25,35,0)
	mc.setBlocks(xs+60,ys,zs+25,xs+60,ys,zs-25,35,0)
	mc.setBlocks(xs+60,ys,zs-25,xs-60,ys,zs-25,35,0)
	mc.setBlocks(xs-60,ys,zs+25,xs-60,ys,zs-25,35,0)
	for n in range (-50,50,10):
		print(n)
		mc.setBlocks(xs+n,ys,zs+25,xs+n,ys,zs-25,35,0)
	mc.setBlocks(xs-60,ys,zs,xs-60,ys+10,zs,35,0)
	mc.setBlocks(xs-60,ys+10,zs+5,xs-60,ys+20,zs+5,35,0)
	mc.setBlocks(xs-60,ys+10,zs-5,xs-60,ys+20,zs-5,35,0)
	mc.setBlocks(xs-60,ys+10,zs-5,xs-60,ys+10,zs+5,35,0)
	mc.setBlocks(xs+60,ys,zs,xs+60,ys+10,zs,35,0)
	mc.setBlocks(xs+60,ys+10,zs+5,xs+60,ys+20,zs+5,35,0)
	mc.setBlocks(xs+60,ys+10,zs-5,xs+60,ys+20,zs-5,35,0)
	mc.setBlocks(xs+60,ys+10,zs-5,xs+60,ys+10,zs+5,35,0)
...
def main():
	mc = init()
	xx,yy,zz,h,k,l = 0,0,0,70,100,50 # comment out when design is good
